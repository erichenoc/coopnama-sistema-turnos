    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          {mfaEnabled && (
            <span className="px-2 py-1 bg-green-500/10 text-green-300 text-xs font-medium rounded-full">
              Activo
            </span>
          )}
        </div>
      ...
      <CardContent>
        ...
        {step === 'setup' && (
          <div className="space-y-4">
            ...
            {qrCode && (
              <div className="flex justify-center p-4 bg-white/[0.06] rounded-lg">
                <img src={qrCode} alt="QR Code" className="w-48 h-48" />
              </div>
            )}
            <div>
              <p className="text-xs text-gray-400 mb-1">O ingresa este codigo manualmente:</p>
              <code className="block p-2 bg-white/[0.06] rounded text-sm font-mono break-all">
                {secret}
              </code>
            </div>
            <div>
        ...
        {step === 'backup' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 p-4 bg-white/[0.04] rounded-lg">
